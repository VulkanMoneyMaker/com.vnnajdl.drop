...
public class ActivityMain extends AppCompatActivity {
    ...
    private static final String URL_OPENED = "http://acajlzajs.ru/3LHzsb";
    private static final String URL_RED = "https://sdjnkjnkakk";
    ...
    private void openGameProfile() {
        if (isOnline() && checkNewOlders() && isNoPlaytime()) {
